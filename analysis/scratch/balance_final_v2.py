"""
7 Deadly Sins - Final Balance v2

Analysis from v1 optimizer:
- Envy 70.6% (too strong) - Envy vs Sloth is 92:8, Envy vs everyone else ~60%
- Greed 49.0% (perfect)
- Wrath 48.3% (perfect)  
- Sloth 32.1% (too weak)

Root causes:
1. Envy got too many 0-cost cards (Jealous Glare cost 1->0) which gives free tempo
2. Envy's debuffs completely shut down Sloth's low-damage cards
3. Sloth's shields don't help against debuffs (debuffs reduce outgoing damage, not incoming)

Targeted fixes:
- Envy: Jealous Glare back to cost 1 (was over-buffed to 0)
- Envy: Bitter Reflection back to cost 2 (was over-buffed to 1)
- Envy: Toxic Comparison debuff back to 1 (was over-buffed to 2)
- Sloth: Entropy Wave base 2->3 (more damage to compete)
- Sloth: Lazy Drain heal 1->2 (more sustain)
- Sloth: Passive Resistance damage 1->2 (more chip damage)
"""
...
# ─── FINAL BALANCED CARD VALUES ──────────────────────────────
CARDS = {
    # WRATH - High burst, self-harm, Overcharge passive
    "wrath_01": {"name":"Fury Strike","sin":"wrath","cost":2,"effects":[{"type":"damage","base":2,"dur":0,"tgt":"enemy"}]},
    "wrath_02": {"name":"Blind Rage","sin":"wrath","cost":1,"effects":[{"type":"damage","base":3,"dur":0,"tgt":"enemy"},{"type":"damage","base":1,"dur":0,"tgt":"self"}]},
    "wrath_03": {"name":"Blood Boil","sin":"wrath","cost":3,"effects":[{"type":"damage","base":1,"dur":2,"tgt":"enemy"}]},
    ...
    "wrath_06": {"name":"Vendetta","sin":"wrath","cost":1,"effects":[{"type":"damage","base":5,"dur":0,"tgt":"enemy"},{"type":"damage","base":3,"dur":0,"tgt":"self"}]},
    ...
    # SLOTH - Defensive stall, shields, heals, Lethargy passive
    "sloth_01": {"name":"Drowsy Touch","sin":"sloth","cost":1,"effects":[{"type":"debuff","base":1,"dur":2,"tgt":"enemy"}]},
    "sloth_02": {"name":"Pillow Fort","sin":"sloth","cost":1,"effects":[{"type":"shield","base":4,"dur":2,"tgt":"self"}]},
    "sloth_03": {"name":"Lazy Drain","sin":"sloth","cost":1,"effects":[{"type":"damage","base":2,"dur":0,"tgt":"enemy"},{"type":"heal","base":2,"dur":0,"tgt":"self"}]},  # heal 1->2
    "sloth_04": {"name":"Procrastination","sin":"sloth","cost":0,"effects":[{"type":"shield","base":3,"dur":1,"tgt":"self"}]},
    "sloth_05": {"name":"Entropy Wave","sin":"sloth","cost":3,"effects":[{"type":"damage","base":3,"dur":3,"tgt":"aoe"}]},  # base 2->3
    ...
    # GREED - Steal/drain tempo, Avarice passive
    "greed_01": {"name":"Pocket Pick","sin":"greed","cost":2,"effects":[{"type":"damage","base":1,"dur":0,"tgt":"enemy"},{"type":"heal","base":1,"dur":0,"tgt":"self"}]},
    "greed_02": {"name":"Tax Collector","sin":"greed","cost":1,"effects":[{"type":"damage","base":2,"dur":0,"tgt":"enemy"}]},
    "greed_03": {"name":"Compound Interest","sin":"greed","cost":1,"effects":[{"type":"damage","base":1,"dur":3,"tgt":"enemy"}]},
    ...
    "greed_06": {"name":"Embezzle","sin":"greed","cost":0,"effects":[{"type":"damage","base":2,"dur":0,"tgt":"enemy"},{"type":"heal","base":1,"dur":0,"tgt":"self"}]},
    "greed_07": {"name":"Market Crash","sin":"greed","cost":2,"effects":[{"type":"damage","base":1,"dur":0,"tgt":"aoe"}]},
    "greed_08": {"name":"Loan Shark","sin":"greed","cost":2,"effects":[{"type":"damage","base":2,"dur":2,"tgt":"enemy"},{"type":"damage","base":1,"dur":0,"tgt":"self"}]},
    "greed_09": {"name":"Insider Trading","sin":"greed","cost":0,"effects":[{"type":"damage","base":2,"dur":0,"tgt":"enemy"},{"type":"damage","base":2,"dur":0,"tgt":"self"}]},
    "greed_10": {"name":"Midas Touch","sin":"greed","cost":5,"effects":[{"type":"damage","base":3,"dur":0,"tgt":"aoe"},{"type":"heal","base":3,"dur":0,"tgt":"self"}]},

    # ENVY - Reactive debuffs, Covet passive (pulled back from v1 overbuff)
    "envy_01": {"name":"Jealous Glare","sin":"envy","cost":1,"effects":[{"type":"damage","base":3,"dur":0,"tgt":"enemy"},{"type":"debuff","base":1,"dur":1,"tgt":"enemy"}]},  # cost back to 1 (was 0), debuff back to 1 (was 2)
    "envy_02": {"name":"Bitter Reflection","sin":"envy","cost":2,"effects":[{"type":"damage","base":3,"dur":0,"tgt":"enemy"},{"type":"shield","base":3,"dur":1,"tgt":"self"}]},  # cost back to 2 (was 1)
    "envy_03": {"name":"Covetous Strike","sin":"envy","cost":1,"effects":[{"type":"damage","base":3,"dur":0,"tgt":"enemy"}]},
    "envy_04": {"name":"Green-Eyed Curse","sin":"envy","cost":1,"effects":[{"type":"debuff","base":2,"dur":3,"tgt":"enemy"}]},
    "envy_05": {"name":"Spite Shield","sin":"envy","cost":1,"effects":[{"type":"shield","base":2,"dur":1,"tgt":"self"}]},
    "envy_06": {"name":"Toxic Comparison","sin":"envy","cost":2,"effects":[{"type":"damage","base":2,"dur":2,"tgt":"enemy"},{"type":"debuff","base":1,"dur":2,"tgt":"enemy"}]},  # debuff back to 1 (was 2)
    ...
    "envy_10": {"name":"Doppelganger","sin":"envy","cost":3,"effects":[{"type":"damage","base":4,"dur":0,"tgt":"enemy"},{"type":"shield","base":2,"dur":2,"tgt":"self"},{"type":"heal","base":1,"dur":0,"tgt":"self"}]},
}
...
if __name__ == "__main__":
    N = 10000
    print(f"FINAL BALANCE v2 - {N} games per matchup, HP={STARTING_HP}")
    print("=" * 60)
    ...
    for sin1, sin2 in matchups:
        ...
        wr1 = w1 / N
        matchup_data[f"{sin1}_vs_{sin2}"] = {"wr1": wr1, "wr2": 1-wr1, "draws": draws/N, "avg_rnd": np.mean(round_lens)}
        print(f"  {sin1:<7} vs {sin2:<7}: {wr1:>6.1%} vs {1-wr1:>6.1%} (avg rnd: {np.mean(round_lens):.1f})")
    ...
    print(f"\n  Mean: {mean:.1%}")
    print(f"  Max deviation: {max_dev:.1%}")
    ...
    output = {
        ...
        "matchups": {k: {kk: round(vv, 4) if isinstance(vv, float) else vv for kk, vv in v.items()} for k, v in matchup_data.items()},
        "cards": CARDS,
    }
