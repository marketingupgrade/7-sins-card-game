...
const FACTIONS = [
  { name: "Wrath", title: "The Berserker's Flame", hex: "#ef4444", passive: "VENGEANCE: Reflects 63.4% of damage taken back to attacker", archetype: "Aggressive damage dealer, high risk/high reward", compound: "Aggressive (powers of 2)", core: "Strike me and feel the wound twice.", personality: "Impatient, confrontational, thrives on chaos" },
  ...
  { name: "Envy", title: "The Poisoner", hex: "#10b981", passive: "JEALOUSY: Dealing damage amplifies target's worst affliction by 10.6%", archetype: "Debuffer, amplifies enemy weaknesses", compound: "Standard (Fibonacci)", core: "Your suffering looks good on you.", personality: "Vindictive, strategic, exploits weaknesses" },
  { name: "Pride", title: "The Sovereign", hex: "#f0f0f0", passive: "HUBRIS: Playing the highest-cost card amplifies all effects by x1.324", archetype: "Big-spell caster, rewards expensive plays", compound: "Aggressive (powers of 2)", core: "Assert dominance.", personality: "Bold, confident, makes dramatic plays" },
  { name: "Lust", title: "The Seducer", hex: "#ec4899", passive: "TEMPTATION: Heals 25% of compound tick damage dealt as HP", archetype: "Sustain damage dealer, heals through violence", compound: "Standard (Fibonacci)", core: "Your pain is my pleasure.", personality: "Persistent, seductive, wears opponents down" },
