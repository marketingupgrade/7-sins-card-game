...
const HOME_STEPS: TutorialStep[] = [
  {
    ...
    body: "A strategic card game where you pick a sin faction, spend Corruption energy, and choose between instant FLAT cards or escalating COMPOUNDING effects. Last sinner standing wins.",
  ...
  },
  {
    ...
    position: "top",
    title: "Four Sin Factions",
    body: "Each faction has a unique playstyle and passive ability. Wrath hits hard, Sloth outlasts, Greed steals, and Envy punishes. Choose wisely.",
  ...
  },
  {
    ...
    position: "top",
    title: "Flat vs Compounding",
    body: "FLAT cards hit once, hard. COMPOUNDING cards tick for 3 rounds with Fibonacci scaling: 1\u00D7, 1\u00D7, 2\u00D7. Pay once, collect thrice. Total value = base \u00D7 4.",
...
const LOBBY_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    body: "Each sin has 12 unique cards and a passive ability. Wrath can Overcharge (burn HP for energy), Sloth carries over unspent energy, Greed gets bonus energy from big plays, and Envy gains energy when outmatched.",
...
const GAME_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    body: "Each player starts with 25 HP. The HP bar shows your current health, shield points (cyan overlay), and whether it's your turn. Hit 0 and you're eliminated.",
  ...
  },
  {
    ...
    body: "Start with 2 energy, gain +1 per round (max 7). Every card costs energy to play. Spend wisely \u2014 you can't play what you can't afford.",
  ...
  },
  {
    ...
    position: "top",
    title: "Your Hand",
    body: "These are your cards. Each shows its type (FLAT or COMPOUND), energy cost (top-right), and effects. Cards you can't afford are dimmed. Click a card to select it.",
  ...
  },
  {
    ...
    position: "top",
    title: "Flat Cards \u26A1",
    body: "Flat cards resolve instantly. Play them, get the full effect immediately, done. Great for burst damage or emergency heals.",
    quip: "Instant gratification. The American dream.",
  },
  {
    id: "game-compound-card",
    page: "game",
    targetSelector: "[data-tutorial='card-hand']",
    position: "top",
    title: "Compounding Cards \uD83D\uDCC8",
    body: "Compounding cards tick for 3 rounds: Tick 1 = base\u00D71, Tick 2 = base\u00D71, Tick 3 = base\u00D72 (the payoff). Total = 4\u00D7 base value. Pay energy once, effects continue for free.",
